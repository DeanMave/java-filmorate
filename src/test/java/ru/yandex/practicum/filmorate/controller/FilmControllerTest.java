...
class FilmControllerTest {
    ...
    public void setUp() {
        ...
        filmService = new FilmService(userService);
    ...
    void addNewFilmWithErrors() {
        ...
        assertEquals("Дата релиза фильма должна быть не раньше 28 декабря 1895 года", thrown3.getMessage());
        Film film4 = new Film();
    ...
    void updateFilmWithErrors() {
        ...
        assertEquals("Дата релиза фильма должна быть не раньше 28 декабря 1895 года", thrown5.getMessage());
